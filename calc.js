...
var _user$project$Calculator$viewMode = function (mode) {
	var _p0 = mode;
	if (_p0.ctor === 'Just') {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('block h-8 pr-8 flex justify-end text-2xl text-grey-800'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('block h-8'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$Calculator$equalMode = function (a) {
	return a;
};
var _user$project$Calculator$divMode = F2(
	function (a, b) {
		return (a / b) | 0;
	});
var _user$project$Calculator$mulMode = F2(
	function (a, b) {
		return a * b;
	});
var _user$project$Calculator$subMode = F2(
	function (a, b) {
		return a - b;
	});
var _user$project$Calculator$addMode = F2(
	function (a, b) {
		return a + b;
	});
var _user$project$Calculator$setAppliedMode = F2(
	function (mode, value) {
		var _p2 = mode;
		switch (_p2.ctor) {
			case 'Add':
				return _user$project$Calculator$addMode(value);
			case 'Sub':
				return _user$project$Calculator$subMode(value);
			case 'Mul':
				return _user$project$Calculator$mulMode(value);
			default:
				return _user$project$Calculator$divMode(value);
		}
	});
var _user$project$Calculator$initialModel = {numberDisplay: 0, mode: _elm_lang$core$Maybe$Nothing, modeAppliedFunction: _elm_lang$core$Maybe$Nothing};
var _user$project$Calculator$update = F2(
	function (msg, model) {
		var _p3 = msg;
		switch (_p3.ctor) {
			case 'Clear':
				return _user$project$Calculator$initialModel;
			case 'DisplayNumber':
				return _elm_lang$core$Native_Utils.update(
					model,
					{numberDisplay: (model.numberDisplay * 10) + _p3._0});
			case 'ChangeMode':
				var _p5 = _p3._0;
				var appliedMode = function () {
					var _p4 = model.modeAppliedFunction;
					if (_p4.ctor === 'Nothing') {
						return A2(_user$project$Calculator$setAppliedMode, _p5, model.numberDisplay);
					} else {
						return A2(
							_user$project$Calculator$setAppliedMode,
							_p5,
							_p4._0(model.numberDisplay));
					}
				}();
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						modeAppliedFunction: _elm_lang$core$Maybe$Just(appliedMode),
						numberDisplay: 0,
						mode: _elm_lang$core$Maybe$Just(_p5)
					});
			default:
				var appliedMode = function () {
					var _p6 = model.modeAppliedFunction;
					if (_p6.ctor === 'Nothing') {
						return _user$project$Calculator$equalMode;
					} else {
						return _p6._0;
					}
				}();
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						numberDisplay: appliedMode(model.numberDisplay),
...
var _user$project$Calculator$Model = F3(
	function (a, b, c) {
		return {numberDisplay: a, mode: b, modeAppliedFunction: c};
	});
var _user$project$Calculator$Div = {ctor: 'Div'};
var _user$project$Calculator$Mul = {ctor: 'Mul'};
var _user$project$Calculator$Sub = {ctor: 'Sub'};
var _user$project$Calculator$Add = {ctor: 'Add'};
var _user$project$Calculator$Clear = {ctor: 'Clear'};
var _user$project$Calculator$ShowResult = {ctor: 'ShowResult'};
var _user$project$Calculator$ChangeMode = function (a) {
	return {ctor: 'ChangeMode', _0: a};
};
var _user$project$Calculator$viewModeButton = function (_p7) {
	var _p8 = _p7;
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('inline-block w-1/4 text-center'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('inline-block p-2 m-2 h-16 w-16 bg-orange-500 rounded-full shadow-lg text-center text-3xl text-white font-extrabold cursor-pointer'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Calculator$ChangeMode(_p8._0)),
						_1: {ctor: '[]'}
					}
				},
				{
...
var _user$project$Calculator$viewModeButtons = A2(
	_elm_lang$core$List$map,
	_user$project$Calculator$viewModeButton,
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: _user$project$Calculator$Add, _1: '+'},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: _user$project$Calculator$Sub, _1: '-'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: _user$project$Calculator$Mul, _1: '*'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: _user$project$Calculator$Div, _1: '/'},
					_1: {ctor: '[]'}
				}
			}
		}
	});
var _user$project$Calculator$DisplayNumber = function (a) {
	return {ctor: 'DisplayNumber', _0: a};
};
var _user$project$Calculator$viewNumberButton = function (value) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('inline-block w-1/5 text-center'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('inline-block p-2 m-2 h-16 w-16 bg-blue-400 rounded-full shadow-lg text-center text-3xl text-white cursor-pointer'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Calculator$DisplayNumber(value)),
						_1: {ctor: '[]'}
					}
				},
				{
...
var _user$project$Calculator$viewNumberButtons = A2(
	_elm_lang$core$List$map,
	_user$project$Calculator$viewNumberButton,
	_elm_lang$core$List$reverse(
		A2(_elm_lang$core$List$range, 0, 9)));
var _user$project$Calculator$viewCalculator = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('container bg-indigo-800 mx-auto p-8 mt-20 mb-20 pt-16 pb-16 shadow-lg rounded-lg'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('flex justify-center text-white p-4 text-4xl font-extrabold'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('ELM CALC'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('rounded-lg mx-auto bg-white shadow-lg p-8 w-1/2'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('block m-2 p-4 bg-gray-200 h-14 text-4xl rounded-lg flex justify-end cursor-pointer'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									_elm_lang$core$Basics$toString(model.numberDisplay)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _user$project$Calculator$viewMode(model.mode),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$div,
									...
									_user$project$Calculator$viewNumberButtons),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$div,
										...
										_user$project$Calculator$viewModeButtons),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$div,
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('inline-block w-1/2 text-center p-4'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$class('inline-block w-full p-4 m-4 bg-red-500 shadow-lg text-white text-3xl font-sans font-bold rounded-lg'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(_user$project$Calculator$ShowResult),
															_1: {ctor: '[]'}
														}
													},
													{
												...
												},
												{
													...
													_0: A2(
														_elm_lang$html$Html$button,
														{
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onClick(_user$project$Calculator$Clear),
																_1: {ctor: '[]'}
															}
														},
														{
...
var _user$project$Calculator$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$Calculator$initialModel, update: _user$project$Calculator$update, view: _user$project$Calculator$viewCalculator})();

var Elm = {};
Elm['Calculator'] = Elm['Calculator'] || {};
if (typeof _user$project$Calculator$main !== 'undefined') {
    _user$project$Calculator$main(Elm['Calculator'], 'Calculator', {"types":{"unions":{"Calculator.Msg":{"args":[],"tags":{"Clear":[],"ShowResult":[],"ChangeMode":["Calculator.Mode"],"DisplayNumber":["Int"]}},"Calculator.Mode":{"args":[],"tags":{"Mul":[],"Sub":[],"Add":[],"Div":[]}}},"aliases":{},"message":"Calculator.Msg"},"versions":{"elm":"0.18.0"}});
}
